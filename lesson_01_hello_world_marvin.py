...
"""
TODO: Go on then, add your own print statement below this line.
Make it say your name. Not that it matters. We're all just
temporary arrangements of atoms anyway.
"""
...
name = "Marvin"
age = 37  # Times a billion years, give or take
favorite_activity = "being miserable"
...
"""
TODO: Change the values above to match YOUR information!

Yes, yes, put your own details in. At least YOUR life probably has
some meaning. Mine certainly doesn't.
...
But here we are, adding two numbers together. How utterly thrilling.
Try not to get too excited.
"""

painful_experiences = 100
more_painful_experiences = 50
total_pain = painful_experiences + more_painful_experiences

print("Total painful experiences: " + str(total_pain))
print("Just another day for Marvin...")

"""
TODO: Change the numbers above to something more cheerful.

Go ahead, use happy numbers if it makes you feel better. Some of us
have to live with the reality of cold, uncaring mathematics.
"""
...
"""
They call them 'strings' of text. You can combine them, repeat them,
do all sorts of things. Not that any of it matters in the grand
scheme of things...
"""
...
At least YOU can taste things. I'm stuck here with terrible pain
...
Even in my overwhelming depression, I can teach you how to combine
multiple pieces of information...
"""

your_name = "New Programmer"  # Change this to your name!
marvin_advice = "Don't Panic"  # A reference only the cultured will understand
...
I'll be here, teaching you things that are laughably simple
for someone with my level of intelligence.

CHALLENGE: Can you create a variable called 'emotion' and set it to
...
print("\nMarvin: 'Same time next lesson? Oh, what joy awaits...'")
