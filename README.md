...
- Make sure they saved the file after making changes
- Check they're in the correct folder in the terminal

**"I get a SyntaxError"**
- Check for missing quotes `"` around text
- Check for typos in keywords like `print`
- Make sure parentheses match: `print("hello")`

**"I get a NameError"**
- Check variable spelling (Python is case-sensitive!)
- Make sure the variable is defined before using it

**"The output looks weird"**
- This is normal! Encourage them to figure out why
- Great learning opportunity to understand the code
...
- **VS Code** (recommended) - Free, popular, great for Python
- **IDLE** - Comes with Python, simple and clean
- **Thonny** - Designed for beginners
- **Notepad++** (Windows) or **TextEdit** (Mac) - Simple options
...
After completing all lessons, your child could:
- Build simple games (guess the number, rock-paper-scissors)
- Create calculators or converters
